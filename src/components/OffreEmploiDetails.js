...
const OffreEmploiDetail = ({ route }) => {
  ...
  const handleApplyPress = () => {
    // Ouvre le client mail avec l'adresse contact
    if (offre.contact) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        <Image source={offre.entreprise.logo_url} style={styles.logo} resizeMode="contain" />
      ...
      <Image source={offre.fichier_url} style={styles.image} resizeMode="cover" />

      <View style={styles.details}>
        <Text style={styles.label}>Type d'offre :</Text>
        <Text style={styles.value}>{offre.type_offre}</Text>

        <Text style={styles.label}>Description :</Text>
        <Text style={styles.value}>{offre.description}</Text>
